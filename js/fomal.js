...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("02/22/2025 00:00:00");
...
if (localStorage.getItem("font") == undefined) {
  localStorage.setItem("font", "LXGW WenKai");
}
...
function setFont(n) {
  ...
  if (n == "default") {
    ...
    document.body.style.fontFamily = "LXGW WenKai,-apple-system, IBM Plex Mono ,monosapce,'微软雅黑', sans-serif";
  }
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://i.imgs.ovh/2025/02/25/7Prae.png);
    --darkmode-bg:url(https://i.imgs.ovh/2025/02/25/7Prae.png);
    --mobileday-bg: url(https://i.imgs.ovh/2025/02/25/7Prae.png);
    --mobilenight-bg: url(https://i.imgs.ovh/2025/02/25/7Prae.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<a class="swf" id="swf_default" href="javascript:;" rel="noopener external nofollow" style="font-family:LXGW WenKai,-apple-system, IBM Plex Mono ,monosapce,'微软雅黑', sans-serif;!important;color:black" onclick="setFont('default')">系统默认</a>
</p>
